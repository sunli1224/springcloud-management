...
//    public static void exportExcel(List<?> data,Class<?> clazz) {
//        File path = new File("");
//        String filePath = path.getAbsolutePath();
//        String fileName = filePath + "\\path\\" + "complexHeadWrite" + System.currentTimeMillis() + ".xlsx";
//        // 这里 需要指定写用哪个class去写，然后写到第一个sheet，名字为模板 然后文件流会自动关闭
//        EasyExcel.write(fileName, clazz).sheet("模板").doWrite(data);
//    }
}
